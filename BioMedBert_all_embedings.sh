...
#SBATCH --output=BioMedBert_all_embeddings.out
#SBATCH --gpus=4
#SBATCH --ntasks=1
...
srun python code/modelling.py --input_file data/actual_BioMedBert_all_embeddings.csv --output_directory results/all_embeddings_modelling/BioMedBert_all_embeddings