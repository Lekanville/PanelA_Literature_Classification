...
#SBATCH --job-name=pubmedbert-base-embeddings_all_embeddings
#SBATCH --output=pubmedbert-base-embeddings_all_embeddings.log
#SBATCH --gpus=4
#SBATCH --ntasks=1
...
srun python code/modelling.py --input_file data/actual_pubmedbert-base-embeddings_all_embeddings.csv \
                                --sbert_model PubMed_BERT \
                                --output_directory results/all_embeddings_modelling/pubmedbert-base-embeddings_all_embeddings